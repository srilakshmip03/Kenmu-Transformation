...
label help_fisherman():
    ...
    menu:
        "You step up and take a deep breath. You have [patience] patience points."
...
label rival_scene():
    call rivalscene from _call_rivalscene
...
label day_two():
    ...
    call day_two_travels from _call_day_two_travels
    call getting_invitation from _call_getting_invitation
    jump continuation
